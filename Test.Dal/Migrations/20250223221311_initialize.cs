        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AnswerStudentId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Attempts_Percent", "[Percent] >= 0 AND [Percent] <= 100");
                    table.ForeignKey(
                        name: "FK_Attempts_Students_AnswerStudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttemptsAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AttemptsAnswers_Attempts_TestAttemptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attempts_AnswerStudentId",
                table: "Attempts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttemptsAnswers_TestAttemptId",
                table: "AttemptsAnswers",
