...
namespace Test.Dal.Migrations
{
    ...
    [Migration("20250318191347_Add Test duration when open test")]
    partial class AddTestdurationwhenopentest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Test.Domain.Entities.TestAccess", b =>
                {
                    ...
                    b.ToTable("TestAccesses", t =>
                        {
                            t.HasCheckConstraint("CK_TestAccesses_TestDuration", "TestDuration > 0");
                        });
                });
